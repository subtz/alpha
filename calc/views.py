...
def home(request):
    return render(request, 'home.html')          # Pass the request to home.html and render it
# calc/views.py
...
def register(request):
    ...
    return render(request, 'register.html', {'form': form})  # Render the register form in the template
# calc/views.py
